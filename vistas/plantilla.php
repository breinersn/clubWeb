...
<body class="hold-transition skin-blue sidebar-mini login-page sidebar-collapse">
  ...
  if(isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok"){
   ...
   echo '<div class="wrapper">';
    ...
    if(isset($_GET["ruta"])){
      ...
      if($_GET["ruta"] == "inicio" ||
         $_GET["ruta"] == "speedys" ||
         $_GET["ruta"] == "carrospeedys" ||
         $_GET["ruta"] == "transportadores" ||
         $_GET["ruta"] == "usuarios" ||
         $_GET["ruta"] == "lideres" ||
         $_GET["ruta"] == "reportes" ||
         $_GET["ruta"] == "usuarios-generales" ||
  ...
  <script src="vistas/js/speedys.js"></script>
  <script src="vistas/js/usuarios.js"></script>
  <script src="vistas/js/usuarios-generales.js"></script>
  <script src="vistas/js/carrospeedys.js"></script>
  <script src="vistas/js/lideres.js"></script>
  <script src="vistas/js/motospeedys.js"></script>
